...
{ 
    ...
    public class cCommon
    {
        ...
        public static bool GeocodeAddress(GooglePoint GP)
        {
            ...
            string sURL = "https://maps.googleapis.com/maps/api/geocode/xml?address=" + GP.Address + "&key="+ GoogleAPIKey;
        ...
        public static bool ReverseGeocode(GooglePoint GP)
        {
            ...
            string sURL = "https://maps.googleapis.com/maps/api/geocode/xml?latlng=" + GP.Latitude.ToString() + "," + GP.Longitude.ToString()  + "&key=" + GoogleAPIKey; ;
            WebRequest request = WebRequest.Create(sURL);
            request.Timeout = 10000;
            // Set the Method property of the request to POST.
            request.Method = "POST";
        ...
        public static string GetLocalPath()
        {
            ...
            for (int i = 1; i < s.Length - 1; i++)
            {
                //Ignore GoogleMapControl sub directory containing ASCX control
                path = path + s[i] + "\\";
            }
            return path;
        }
